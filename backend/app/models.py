...
class PlayerPoolEntry(Base):
    ...
    auto_excluded = Column(Boolean, default=False)  # if player was automatically excluded due to zero/null projections
...
class TeamStats(Base):
    ...
    salary = Column(Integer, default=0)  # DraftKings salary for this team's defense
