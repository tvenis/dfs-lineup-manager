#!/usr/bin/env python3
"""
Script to automatically drop the old team_defense_stats table.
This version runs without user confirmation for automated environments.
"""
...
def main():
    ...
    try:
        ...
        if count == 0:
            print("⚠️  team_stats table is empty, but proceeding with drop as requested")
